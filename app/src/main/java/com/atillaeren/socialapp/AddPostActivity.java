...
public class AddPostActivity extends AppCompatActivity {
    ...
    private void handleSendText(Intent intent) {
        ...
        String sharedText = intent.getParcelableExtra(Intent.EXTRA_TEXT);
        if (sharedText!=null) {
    ...
    private void updateWithoutImage(String title, String description, String editPostId) {
        ...
        //add post information to hashmap
        hashMap.put("uid", uid);
        ...
        mPictureRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        //for post-image name, post-id, publist-time
                        String timeStamp = String.valueOf(System.currentTimeMillis());
                        String filePathAndName = "Posts/"+ "post_"+timeStamp;
    ...
    private void loadPostData(String editPostId) {
        ...
        // get post information using uid of post for update post
            ...
            ref.putBytes(data)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()) {
                                //url added send to db
                                HashMap<Object, String> hashMap = new HashMap<>();
                                hashMap.put("uid", uid); hashMap.put("uName", name);
                                hashMap.put("uEmail", email); hashMap.put("uDp", dp);
                                hashMap.put("pId", timeStamp); hashMap.put("pTitle", title);
                                hashMap.put("pDesc", description); hashMap.put("pImage", downloadUri);
                                hashMap.put("pTime", timeStamp); hashMap.put("pLikes", "0");
                                hashMap.put("pComments", "0");

                                //path to store post data
                                DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Posts");
                                //put data on this ref
