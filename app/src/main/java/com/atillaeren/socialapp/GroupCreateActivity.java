...
public class GroupCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Create Group Chat");
    ...
    private void startCreateGroup() {
        ...
        if (image_uri == null) {
            //create without icon image
            createGroup(""+gTimeStamp,""+groupTitle,""+groupDesc, "");
        }
        else {
            //create with icon image
            //upload image, path to image
            String fileNamePath = "Group_Images/" + "image" + gTimeStamp;
    ...
    private void createGroup(String gTimeStamp, String groupTitle, String groupDesc, String groupIcon) {
        //setting group informations
        ...
        reference.child(gTimeStamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        // adding group participants information to db / add currently signed in user (creator) to participants node
                        HashMap<String, String> hashMap1 = new HashMap<>();
                        hashMap1.put("uid", firebaseAuth.getUid());
                        hashMap1.put("role", "creator");
                        hashMap1.put("timestamp", gTimeStamp);
                        DatabaseReference reference1 = FirebaseDatabase.getInstance().getReference("Groups");
                        reference1.child(gTimeStamp).child("Participants").child(firebaseAuth.getUid()).setValue(hashMap1)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        pd.dismiss();
